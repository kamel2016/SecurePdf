...
namespace SecureDocumentPdf.Controllers
{
    ...
    public class VerifyController : ControllerBase
    {
        ...
        //        /// <summary>
        //        /// Page de vérification interactive pour afficher les résultats
        //        /// </summary>
        //        [HttpGet("page")]
        ...
        //            [FromQuery] string user)
        //        {
        //            var verificationUrl = $"api/verify/document?id={id}&hash={hash}&user={Uri.EscapeDataString(user ?? "")}";
        ...
        //        .success-badge {{ background: #28a745; color: white; padding: 20px; border-radius: 10px; text-align: center; margin: 20px 0; }}
        //        .error-badge {{ background: #dc3545; color: white; padding: 20px; border-radius: 10px; text-align: center; margin: 20px 0; }}
        ...
        //                        <div class='info-item'>
        //                            <span class='info-label'>ID Document:</span><br>
        //                            <small class='text-monospace'>{data.document.id}</small>
        //                        </div>
        //                        <div class='info-item'>
        //                            <span class='info-label'>Fichier:</span><br>
        //                            <small>{data.document.fileName}</small>
        //                        </div>
        //                        <div class='info-item'>
        //                            <span class='info-label'>Créé par:</span><br>
        //                            <small>{data.document.createdBy}</small>
        //                        </div>
        //                        <div class='info-item'>
        //                            <span class='info-label'>Date:</span><br>
        //                            <small>{new Date(data.document.createdAt).toLocaleString('fr-FR')}</small>
        //                        </div>
        //                        <div class='info-item'>
        //                            <span class='info-label'>IP d'origine:</span><br>
        //                            <small>{data.document.originIP}</small>
        //                        </div>
        //                    </div>
        ...
        //                        </div>
        //                        <div class='info-item'>
        //                            <span class='info-label'>Hash Original:</span><br>
        //                            <small class='text-monospace'>{data.integrity.originalHash}</small>
        //                        </div>
        //                        <div class='info-item'>
        //                            <span class='info-label'>Hash Final:</span><br>
        //                            <small class='text-monospace'>{data.integrity.processedHash}</small>
        //                        </div>
        //                    </div>
        ...
        //                        <div class='info-item'>
        //                            <i class='fas fa-check-circle checkmark me-2'></i>
        //                            Chiffrement {data.security.encryptionLevel}
        //                        </div>
        //                        <div class='info-item'>
        //                            <i class='fas fa-check-circle checkmark me-2'></i>
        ...
        //                            <strong>ALERTE SÉCURITÉ:</strong> Le hash ne correspond pas!
        //                            Ce document pourrait avoir été modifié.
        //                        </div>
        //                    ` : ''}
        //                `;
        //            }}
